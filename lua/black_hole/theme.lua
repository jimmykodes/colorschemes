...
function M.setup()
  ...
  hl(0, "Hint", { fg = c.hint,  })
  hl(0, "HintMsg", { link = "Hint" })
  hl(0, "Ignore", { fg = c.cyan, bg = c.bg, bold = true,  })
  hl(0, "IncSearch", { bg = c.search,  })
  hl(0, "Info", { fg = c.info,  })
  hl(0, "InfoMsg", { link = "Info" })
  ...
  hl(0, "Substitute", { bg = c.replace,  })
  hl(0, "Success", { fg = c.success,  })
  hl(0, "SuccessMsg", { link = "Success" })
  ...
  hl(0, "Visual", { bg = c.search,  })
  hl(0, "VisualNOS", { bg = c.bg_light,  })
  hl(0, "Warning", { fg = c.warning,  })
  hl(0, "WarningMsg", { link = "Warning" })
  ...
  hl(0, "NvimTreeGitDirtyIcon", { link = "NvimTreeGitFileDirtyHL" })
  hl(0, "NvimTreeGitFileDirtyHL", { fg = c.yellow,  })
  hl(0, "NvimTreeGitFileNewHL", { fg = c.purple,  })
  hl(0, "NvimTreeGitFileRenamedHL", { fg = c.magenta,  })
  hl(0, "NvimTreeGitFileStagedHL", { fg = c.green,  })
  hl(0, "NvimTreeGitNewIcon", { link = "NvimTreeGitFileNewHL" })
  hl(0, "NvimTreeGitRenamedIcon", { link = "NvimTreeGitFileRenamedHL" })
  hl(0, "NvimTreeGitStagedIcon", { link = "NvimTreeGitFileStagedIcon" })
  ...
  hl(0, "StatusLineInfo", { fg = c.bg_light, bg = c.blue,  })
  hl(0, "StatusLineInfoInverted", { fg = c.blue, bg = c.bg_light,  })
  hl(0, "StatusLineInverted", { fg = c.bg_light, bg = c.fg,  })
