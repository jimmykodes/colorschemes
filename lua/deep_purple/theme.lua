...
function M.setup()
	...
	hl(0, "IncSearch", { fg = c.alt_bg, bg = c.search_blue,  })
	...
	hl(0, "MatchWord", { fg = c.blue, bg = c.alt_bg,  })
	...
	hl(0, "Search", { fg = c.alt_bg, bg = c.search_blue,  })
	...
	hl(0, "Substitute", { fg = c.alt_bg, bg = c.search_orange,  })
	...
	hl(0, "Visual", { fg = c.alt_bg, bg = c.ui_blue,  })
	...
	hl(0, "QuickScopePrimary", { fg = c.purple_test, underline = true,  })
	hl(0, "QuickScopeSecondary", { fg = c.cyan, underline = true,  })
	...
	hl(0, "markdownBold", { fg = c.yellow, bold = true,  })
