...
function M.setup()
  ...
  hl(0, "NvimTreeGitFileDirtyHL", { fg = c.sign_diff,  })
  hl(0, "NvimTreeGitFileDirtyIcon", { link = "NvimTreeGitFileDirtyHL" })
  hl(0, "NvimTreeGitFileNewHL", { fg = c.sign_change,  })
  hl(0, "NvimTreeGitFileNewIcon", { link = "NvimTreeGitFileNewHL" })
  hl(0, "NvimTreeGitFileRenameHL", { fg = c.sign_change,  })
  hl(0, "NvimTreeGitFileRenameIcon", { link = "NvimTreeGitFileRenameHL" })
  hl(0, "NvimTreeGitFileStagedHL", { link = "sign_add" })
  hl(0, "NvimTreeGitFileStagedIcon", { link = "NvimTreeGitFileStagedIcon" })
