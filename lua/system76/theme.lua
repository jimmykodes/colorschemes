...
function M.setup()
	...
	hl(0, "DiffviewVertSplit", { fg = "fg", bg = c.bg })
	...
	hl(0, "ColorColumn", { fg = "fg", bg = c.dark })
	...
	hl(0, "CursorColumn", { fg = "fg", bg = c.dark })
	hl(0, "CursorIM", { fg = c.cursor_fg, bg = c.cursor_bg })
	hl(0, "CursorLine", { fg = "fg", bg = c.dark })
	...
	hl(0, "VertSplit", { fg = c.bg, bg = c.fg })
	hl(0, "Visual", { fg = "fg", bg = c.ui_blue })
	hl(0, "VisualNOS", { fg = "fg", bg = c.alt_bg })
	...
	-- misc
	hl(0, "CompeDocumentation", { fg = "fg", bg = c.alt_bg })
	hl(0, "debugBreakpoint", { fg = c.red, bg = "bg" })
	hl(0, "debugPc", { fg = "fg", bg = c.cyan })
	...
	-- telescope
	hl(0, "TelescopeBorder", { fg = c.fg, bg = c.bg })
	...
	hl(0, "WhichKeyFloat", { fg = "fg", bg = c.dark })
