...
function M.setup()
	...
	hl(0, "DiffviewVertSplit", { "fg", bg = c.bg })
	...
	hl(0, "Italic", { "fg", "bg", italic = true })
	hl(0, "Keyword", { fg = c.purple })
	hl(0, "Label", { fg = c.purple })
	hl(0, "LineNr", { fg = c.gray, "bg" })
	hl(0, "Macro", { fg = c.purple })
	hl(0, "MatchParen", { fg = c.hint_blue, bg = c.bg, underline = true })
	hl(0, "MatchParenCur", { "fg", "bg", underline = true })
	hl(0, "MatchWord", { "fg", "bg", underline = true })
	hl(0, "MatchWordCur", { "fg", "bg", underline = true })
	...
	hl(0, "NormalFloat", { "fg", bg = c.dark })
	hl(0, "NormalNC", { fg = c.fg, bg = c.bg })
	hl(0, "Number", { fg = c.green })
	hl(0, "Operator", { fg = c.fg })
	hl(0, "Pmenu", { fg = c.light_gray, bg = c.popup_back })
	hl(0, "PmenuSbar", { "fg", bg = c.alt_bg })
	hl(0, "PmenuSel", { fg = c.alt_bg, bg = c.blue })
	hl(0, "PmenuThumb", { "fg", bg = c.gray })
	hl(0, "PreCondit", { fg = c.purple })
	hl(0, "PreProc", { fg = c.purple })
	hl(0, "Question", { fg = c.orange })
	hl(0, "QuickFixLine", { "fg", bg = c.accent })
	hl(0, "Repeat", { fg = c.purple })
	hl(0, "Search", { fg = c.light_gray, bg = c.search_blue })
	hl(0, "SignColumn", { "fg", bg = c.bg })
	hl(0, "Special", { fg = c.orange })
	hl(0, "SpecialChar", { fg = c.white })
	hl(0, "SpecialComment", { fg = c.comment })
	hl(0, "SpecialKey", { fg = c.blue, "bg", bold = true })
	hl(0, "SpellBad", { fg = c.error_red, "bg", underline = true })
	hl(0, "SpellCap", { fg = c.yellow, "bg", underline = true })
	hl(0, "SpellLocal", { fg = c.green, "bg", underline = true })
	hl(0, "SpellRare", { fg = c.purple, "bg", underline = true })
	...
	hl(0, "LspDiagnosticsUnderlineError", { "fg", "bg", underline = true })
	hl(0, "LspDiagnosticsUnderlineHint", { "fg", "bg", underline = true })
	hl(0, "LspDiagnosticsUnderlineInformation", { "fg", "bg", underline = true })
	hl(0, "LspDiagnosticsUnderlineWarning", { "fg", "bg", underline = true })
	...
	hl(0, "QuickScopePrimary", { fg = c.purple_test, "bg", underline = true })
	hl(0, "QuickScopeSecondary", { fg = c.cyan_test, "bg", underline = true })

	-- markdown
	hl(0, "markdownBlockquote", { fg = c.accent })
	hl(0, "markdownBold", { fg = c.yellow, "bg", bold = true })
	...
	hl(0, "markdownItalic", { "fg", "bg", italic = true })
	...
	hl(0, "markdownUrl", { fg = c.cyan, "bg", underline = true })

	-- misc
	hl(0, "CompeDocumentation", { "fg", bg = c.alt_bg })
	hl(0, "debugBreakpoint", { fg = c.red, "bg" })
	hl(0, "debugPc", { "fg", bg = c.cyan })
	...
	hl(0, "NvimTreeOpenedFolderName", { fg = c.cyan, "bg", italic = true })
	hl(0, "NvimTreeRootFolder", { fg = c.fg, "bg", bold = true })
	...
	hl(0, "TelescopeMatching", { fg = c.info_yellow, "bg", bold = true })
	...
	hl(0, "TSEmphasis", { "fg", "bg", italic = true })
	...
	hl(0, "TSPunctBracket", { fg = c.fg, "bg" })
	hl(0, "TSPunctDelimiter", { fg = c.fg, "bg" })
	...
	hl(0, "TSText", { fg = c.fg })
	hl(0, "TSTitle", { fg = c.blue, "bg", bold = true })
	hl(0, "TSType", { fg = c.orange })
	hl(0, "TSTypeBuiltin", { fg = c.blue })
	hl(0, "TSURI", { fg = c.yellow_orange, "bg", underline = true })
	hl(0, "TSUnderline", { "fg", "bg", underline = true })
	...
	hl(0, "WhichKeyFloat", { "fg", bg = c.dark })
