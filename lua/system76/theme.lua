...
function M.setup()
	...
	hl(0, "DiffviewVertSplit", { fg = "NONE", bg = bg })
	...
	hl(0, "diffFileId", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "ColorColumn", { fg = "NONE", bg = dark })
	...
	hl(0, "CursorColumn", { fg = "NONE", bg = dark })
	...
	hl(0, "Visual", { fg = "NONE", bg = ui_blue })
	hl(0, "VisualNOS", { fg = "NONE", bg = alt_bg })
	...
	hl(0, "QuickScopePrimary", { fg = c.purple_test, bg = "NONE", underline = true })
	hl(0, "QuickScopeSecondary", { fg = c.cyan_test, bg = "NONE", underline = true })

	-- markdown
	hl(0, "markdownBlockquote", { fg = c.accent })
	hl(0, "markdownBold", { fg = c.yellow, bg = "NONE", bold = true })
	...
	-- misc
	hl(0, "CompeDocumentation", { fg = "NONE", bg = alt_bg })
	hl(0, "debugBreakpoint", { fg = c.red, bg = "NONE" })
	hl(0, "debugPc", { fg = "NONE", bg = cyan })
	...
	hl(0, "NvimTreeOpenedFolderName", { fg = c.cyan, bg = "NONE", italic = true })
	...
	hl(0, "TSText", { fg = c.fg })
	hl(0, "TSTitle", { fg = c.blue, bg = "NONE", bold = true })
	hl(0, "TSType", { fg = c.orange })
	hl(0, "TSTypeBuiltin", { fg = c.blue })
	hl(0, "TSURI", { fg = c.yellow_orange, bg = "NONE", underline = true })
	...
	hl(0, "WhichKeyFloat", { fg = "NONE", bg = dark })
