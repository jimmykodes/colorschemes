...
function M.setup()
  ...
  hl(0, "NvimTreeGitFileDirtyHL", { link = "DiffChange" })
  hl(0, "NvimTreeGitFileDirtyIcon", { link = "NvimTreeGitFileDirtyHL" })
  hl(0, "NvimTreeGitFileNewHL", { link = "DiffText" })
  hl(0, "NvimTreeGitFileNewIcon", { link = "NvimTreeGitFileNewHL" })
  hl(0, "NvimTreeGitFileStagedHL", { link = "DiffAdd" })
  ...
  hl(0, "NvimTreeOpenedFolderIcon", { link = "NvimTreeOpenedFolderName" })
